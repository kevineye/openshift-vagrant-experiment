...
sshpass -p vagrant ssh-copy-id -i ~/.ssh/id_rsa.pub master.lan

ssh-keyscan node1.lan >> ~/.ssh/known_hosts
sshpass -p vagrant ssh-copy-id -i ~/.ssh/id_rsa.pub node1.lan

ssh-keyscan node2.lan >> ~/.ssh/known_hosts
sshpass -p vagrant ssh-copy-id -i ~/.ssh/id_rsa.pub node2.lan
#!/bin/sh
